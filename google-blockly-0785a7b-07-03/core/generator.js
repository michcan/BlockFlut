...
Blockly.Generator.prototype.nombredepile=0;
Blockly.Generator.prototype.numblock=0;
Blockly.Generator.prototype.steps=0;
Blockly.Generator.prototype.seqs=Array();
...
Blockly.Generator.prototype.workspaceToCode = function(workspace) {
  ...
  for(var x = 0; x<code.length; x++)
  {
	...
	+ code[x]
	+ "  self.count"+x+"+=1\n"
	+ "  if self.count"+x+">=len(self.seq"+x+".seq):\n"
	+ "    self.count"+x+"=0\n"
    /*
    code[x]+="seq"+x+"=Seq(time=0.01,seq=["+this.seqs[x].join(',')+"]).play()\n";
    code[x]+="tf"+x+"=TrigFunc(seq"+x+",loop"+x+")\n";
    */
  }
...
Blockly.Generator.prototype.blockToCode = function(block) {
  ...
  Blockly.Generator.prototype.numblock+=1;
  /*
  if(block.getSurroundParent()){
    console.log(block.getSurroundParent().type);
  }
  */
  ...
  if (goog.isArray(code)) {
    ...
    if(block.getSurroundParent()){
      ...
      code="if self.count"+this.nombredepile+"==" + this.steps + ":\n"
      +this.prefixLines(/** @type {string} */ ("try : \n"), this.INDENT)
      +this.prefixLines(/** @type {string} */ (code), this.INDENT+this.INDENT)
      +this.prefixLines(/** @type {string} */ ("except : \n"), this.INDENT)
      +this.prefixLines(/** @type {string} */ ("pass \n"), this.INDENT+this.INDENT);
      if (Blockly.Python.valueToCode(block, 'durée', Blockly.Python.ORDER_ATOMIC)!="") 
		{
			...
			this.seqs[this.nombredepile][this.steps]=dure;
		}else{
